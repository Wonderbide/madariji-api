-- Insert WORD_ANALYSIS_V1 version 5.0 with enhanced theological context
-- This version adds subtle guidance for classical Arabic Islamic terminology interpretation

-- First, deactivate the current active version
UPDATE prompt_library SET is_active = false WHERE prompt_key = 'WORD_ANALYSIS_V1' AND is_active = true;

-- Insert new version 5.0
INSERT INTO prompt_library (id, prompt_key, version, prompt_text, is_active, created_at)
VALUES (
    gen_random_uuid(),
    'WORD_ANALYSIS_V1',
    '5.0',
...
11. **TRADUCTION DYNAMIQUE** : Fournis la traduction du "Mot Cible" dans la langue spécifiée (%s). TOUJOURS donner la traduction du mot seul, comme dans un dictionnaire.
